...
public interface CcAreaCityService extends IBaseService {
     ...
     * @param codes 城市编号
     */
    List<Tree> addArea(CcArea ccArea, String[] codes)throws BadHanyuPinyinOutputFormatCombination;
     ...
     * @param codes 城市编号
     */
    List<Tree> editArea(CcArea ccArea, String[] codes)throws BadHanyuPinyinOutputFormatCombination;
