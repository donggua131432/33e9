    ...
    <script type="text/javascript">
        $(function(){
            ...
            uploader = WebUploader.create({
                ...
                // 文件接收服务端。
                server: '<c:url value="/maskNum/maskNumExcelUpload"/>?appid=${appid}&uid=${uid}&sid=${sid}',
                // 选择文件的按钮。可选。
            ...
            uploader.on( 'uploadSuccess', function(file,response) {
                ...
                if(response.status == "2"){
                    window.location.href="<c:url value='/maskNum/downLoadErrorMaskNum'/>";
                }
    ...
    <div class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-9" style="margin-top: 2px;">
                <a href="${appConfig.resourcesRoot}/download/导入隐私号模板.xls" style="color: blue;">模板下载</a>
            </div>
        </div>
    </div>
</div>
