...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            // datatables ajax 选项
            var datatables_ajax = {
                url: '<c:url value='/ecc/pageAppList'/>',
                type: 'POST',
                "data": function(d){
            ...
            var columnDefs = [
...

                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        _ex_in += '<a title="编辑" href="javascript:;" onclick="openRelayDialog(\'编辑\',\'<c:url value="/eccAppInfo/toEdit?appid='+full.appId+'&managerType=edit"/>\',\'1000\',\'800\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>';
                        _ex_in += '<a title="查看" href="javascript:;" onclick="openRelayDialog(\'查看\',\'<c:url value="/eccAppInfo/toEdit?appid='+full.appId+'&managerType=view"/>\',\'1000\',\'800\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"></i>查看</a>';
        ...
        function downloadReport(type) {
            ...
            window.open("<c:url value='/ecc/downloadReport'/>?params[companyName]=" + $("#companyName").val()
...
<div class="pd-20">
    <div class="text-c">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        客户名称：<input type="text" id="companyName" name="companyName" class="input-text" placeholder="客户名称" style="width:200px;"><br><br>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="openAppDialog('创建应用','<c:url value="/ecc/toAddApp"/>','800','700')" class="btn btn-primary radius"> 创建应用</a>
        </span>
        <span class="r">
