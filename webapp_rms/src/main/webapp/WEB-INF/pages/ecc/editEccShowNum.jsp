...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            initPCArea("pcode", "ccode", "请选择", "${eccShownum.pcode}", "${eccShownum.ccode}", true);
//            initPCArea("pcode", "ccode", "请选择");

            $("#editEccShowNumForm").Validform({
                tiptype: 2,
                ajaxPost: true,
...
//                            parent.dataTables.fnDraw();
                ...
                datatype: {
                    ...
                    "number":function(gets, obj, curform, datatype){
                        ...
                        $.ajax({
                            type:"post",
                            url:'<c:url value="/eccShowNumPool/checkEditEccShowNum"/>',
                            dataType:"json",
                            async:false,
...
<body>
<div class="pd-20">
    <form action="<c:url value="/eccShowNumPool/updateEccShowNum"/>" method="post" class="form form-horizontal" id="editEccShowNumForm">
        <input type="hidden" value="${eccShownum.id}" name="id"/>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" placeholder="请输入号码" value="${eccShownum.number}" id="number" name="number" datatype="number" maxlength="30" errormsg="格式不正确" nullmsg="号码不能为空"/>
            </div>
            <div class="col-4"></div>
        </div>
