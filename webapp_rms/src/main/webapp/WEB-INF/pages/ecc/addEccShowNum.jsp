...
//                            parent.dataTables.fnDraw();
                ...
                datatype: {
                    ...
                    "number":function(gets, obj, curform, datatype){
                        ...
                        $.ajax({
                            type:"post",
                            url:'<c:url value="/eccShowNumPool/checkEccShowNum"/>',
                            dataType:"json",
                            async:false,
                            data:{'number' : gets},
...
<body>
<div class="pd-20">
    <form action="<c:url value="/eccShowNumPool/addEccShowNum"/>" method="post" class="form form-horizontal" id="addSipPhoneForm">
