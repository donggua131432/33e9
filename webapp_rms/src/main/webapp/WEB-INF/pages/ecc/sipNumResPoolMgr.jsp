...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            initSelect("ipPort", "<c:url value='/sipNumResPool/getIPPortList'/>", "ipPort", "ipPort", "请选择");

            var dataTablesAjax = {
                url: '<c:url value='/sipNumResPool/getSipPhoneList'/>',
                type: 'POST',
                "data": function(d){
        ...
        function addPhone(){
            openDialog('SIP号码添加','<c:url value="/sipNumResPool/toAddPhone"/>','600','450');
        }

        function importPhone(){
            openDialog('批量导入', '<c:url value="/sipNumResPool/importPhone"/>', '600', '260');
        }
        ...
        function downloadSipPhone() {
            ...
            window.open("<c:url value='/sipNumResPool/downloadSipPhonePool'/>?" + formData);
        }
            ...
            if (strId) {
                layer.confirm('是否确认删除？', {
                    ...
                    $.ajax({
                        ...
                        url: "<c:url value='/sipNumResPool/deletePhones'/>",
...
<div class="page-container" style="padding: 20px;">
    <%--<form class="form form-horizontal" id="form-article-add">--%>
        <div id="tab-system" class="HuiTab">
            <div ><H2><span>接听号码-SIP号码</span></H2></div>


        <%--<div class="tabBar cl"><span>接听号码</span></div>--%>
            <div class="tabCon">
                <form id="searchFrom" class="form form-horizontal">
                    <div class="row cl">
                        接听号码：
                        <input type="text" class="input-text" style="width:186px" placeholder="请输入接听号码" id="sipPhone" name="sipPhone"/>&nbsp;&nbsp;&nbsp;&nbsp;
                        状态：
