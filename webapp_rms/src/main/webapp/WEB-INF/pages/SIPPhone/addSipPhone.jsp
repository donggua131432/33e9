...
//                            parent.dataTables.fnDraw();
                ...
                datatype: {
                    ...
                    "sipphone":function(gets, obj, curform, datatype){
                        ...
                        $.ajax({
                            type:"post",
                            url:'<c:url value="/pubNumResPool/checkSipPhone"/>',
                            dataType:"json",
                            async:false,
                            data:{'sipphone' : gets},
...
<body>
<div class="pd-20">
    <form action="<c:url value="/pubNumResPool/addSipPhone"/>" method="post" class="form form-horizontal" id="addSipPhoneForm">
