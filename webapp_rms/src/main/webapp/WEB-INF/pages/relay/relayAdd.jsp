...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#form-relay-add").Validform({
            ...
            datatype : {
                ...
                ipport : function(gets, obj, curform, datatype) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<c:url value='/relay/checkUnique'/>",
                        data: data,
                        async : false,
                        success: function(msg){
                            if (msg.code == 'ok') {
        ...
        //$("#isFSProxy").data("isFSProxy",$("#isFSProxy").html());
...
<body>
<div class="pd-20">
    <form action="<c:url value='/relay/addRelay'/>" method="post" class="form form-horizontal" id="form-relay-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-7">
                <input type="text" class="input-text" value="" placeholder="请输入中继名称" id="relayName" name="relayName" datatype="_ajax" maxlength="30" data-ajax="{'url':'<c:url value="/relay/checkUnique"/>',msg:'该中继名称已经存在',_regex:{type:'relayName',msg:'名称格式不正确'}}" nullmsg="中继名称不能为空"/>
            </div>
            <div class="col-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-7">
                <input type="text" class="input-text" value="" placeholder="请输入中继号" id="relayNum" name="relayNum" datatype="_ajax" maxlength="5" data-ajax="{'url':'<c:url value="/relay/checkUnique"/>',msg:'该中继编号已经存在',_regex:{type:'relayNum',msg:'格式不正确'}}" nullmsg="中继编号不能为空"/>
            </div>
            <div class="col-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-2">
                <select id="useType" name="useType"  class="select" style="width:140px;height: 31px" datatype="*"  nullmsg="请选择！" >
                    ...
                    <option value="00">客户</option>
                    <option value="01">供应商</option>
                    <option value="02">平台内部</option>
                </select>
            </div>
            <div class="col-1"></div>
            <label class="form-label col-2">业务类型：</label>
            <div class="formControls col-2">
                <select id="busType" name="busType" class="select" style="width:140px;height: 31px" datatype="*"  nullmsg="请选择！" >
                    <option value="">请选择</option>
                    <option value="03">SIP</option>
                    <option value="05">云话机</option>
                    <option value="01">智能云调度</option>
                    <option value="91">呼叫中心代答中继</option>
                </select>
            </div>
            <div class="col-3"></div>
        </div>
        ...
        <div id="isFSProxy">
            <div class="row cl">
                ...
                <div class="formControls col-3">
                    <input type="text" class="input-text" style="width: 155px;" value="" placeholder="请输入外域对端区号" name="areacode" datatype="areacode" maxlength="8"  errormsg="输入的格式不正确"/>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入外域对端IP" id="ip1" name="ip1" datatype="ipport" maxlength="30" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-1"></div>
                <label class="form-label col-2">端口：</label>
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入端口" id="port1" name="port1" datatype="ipport" maxlength="5" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-3"></div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入外域本端IP" id="ip2" name="ip2" datatype="ipport" maxlength="30" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-1"></div>
                <label class="form-label col-2">端口：</label>
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入端口" id="port2" name="port2" datatype="ipport" maxlength="5" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-3"></div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入内域对端IP" id="ip3" name="ip3" datatype="ipport" maxlength="30" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-1"></div>
                <label class="form-label col-2">端口：</label>
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入端口" id="port3" name="port3" datatype="ipport" maxlength="5" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-3"></div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入内域本端IP" id="ip4" name="ip4" datatype="ipport" maxlength="30" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-1"></div>
                <label class="form-label col-2">端口：</label>
                <div class="formControls col-2">
                    <input  type="text" class="input-text" value="" placeholder="请输入端口" id="port4" name="port4" datatype="ipport" maxlength="5" nullmsg="不能为空"  errormsg="格式错误"/>
                </div>
                <div class="col-3"></div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-7">
                    <input  type="text" class="input-text" value="" placeholder="请输入SIP-URL域名" id="sipUrl" name="sipUrl" datatype="/^[\u4E00-\u9FA5-0-9a-zA-Z\(\)\.\-\_\~\[\]\!\*\')]*$/"  nullmsg="SIP-URL域名不能为空！" maxlength="64"/>
                </div>
                <div class="col-3"></div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-7">
                    <input  type="text" class="input-text" value="" placeholder="请输入出局R-URL" id="sipOutnoPr" name="sipOutnoPr" datatype="/^[0-9]{0,16}$/"  maxlength="16"/>
                </div>
                <div class="col-3"></div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-7">
                    <%--<input  type="text" class="input-text" value="" placeholder="如：3d" id="sipBusiness_16" name="sipBusiness_16" datatype="/^[0-9a-fA-F]*$/"  maxlength="8"/>--%>
                    <div class="skin-minimal">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-7">
                <input type="text" class="input-text" value="" placeholder="请输入并发数" id="maxConcurrent" name="maxConcurrent" datatype="_ajax" data-ajax="{_regex:{type:'maxConcurrent',msg:'格式不正确'}}" maxlength="5"/>
            </div>
            <div class="col-3"></div>
        </div>
