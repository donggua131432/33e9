...
<body>
<div class="pd-20">
    <form action="<c:url value="/relayNumPool/addNumbers" />" method="post" class="form form-horizontal" id="addRelayNumberForm">

        <input type="hidden" name="relayNum" value="${relayNum}"/>
        <div class="row cl">
