    ...
    <script type="text/javascript">
        $(function(){
            ...
            uploader = WebUploader.create({
                ...
                // 文件接收服务端。
                server: '<c:url value="/axbNumResPool/AxbPhoneExcelUpload"/>',
                // 选择文件的按钮。可选。
            ...
            uploader.on( 'uploadSuccess', function(file,response) {
                ...
                if(response.status == "2"){
                    window.location.href="<c:url value='/axbNumResPool/downLoadErrorAxbPhone'/>";
                }
    ...
    <div class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-9" style="margin-top: 2px;">
                <a href="${appConfig.resourcesRoot}/download/虚拟小号公共号码池导入模板.xls" style="color: blue;">模板下载</a>
            </div>
        </div>
    </div>
</div>
