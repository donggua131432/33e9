...
//                    $("#routeCode").show();
                    $.ajax({
                        type:"post",
                        url:"<c:url value='/znydd/updateRoute'/>",
                        dataType:"json",
...
//                        layer.tips(data.info,'#routeCode',{icon: 1})
                ...
                validform.submitForm(false,"<c:url value='/znydd/updateRoute'/>");
            });
        });
    </script>
</head>
        ...
        <form id="route">
            <div class="pd-20">
                <div class="form form-horizontal">
                    ...
                    <div class="row cl">
                        <label class="form-label col-4">应用号码：</label>
                        <div class="formControls col-8">
                            <span class="mt-3">
                    ...
                    <div class="row cl">
                        <label class="form-label col-4">创建时间：</label>
                        <div class="formControls col-8">
                        <span class="mt-3">
