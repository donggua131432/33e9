...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // datatables ajax 选项
        var datatables_ajax = {
            url: '<c:url value='/voiceVerify/pageVoiceList'/>',
            type: 'POST',
            "data": function(d){
                ...
                "render": function(data, type, full) {
                    ...
                    if(auditStatus == "00"){
                        return '<a title="审核" href="javascript:;" ' +
                                'onclick="system_log_show(\'语音验证码模板审核\',\'<c:url value="/voiceVerify/toTempCertification?type=edit"/>\',' + full.id + ',\'550\',\'550\')" class="ml-5" style="text-decoration:none; color:blue">审核</a>';
                    }else if(auditStatus == "01"){
                        return '<a title="查看" href="javascript:;" ' +
                                'onclick="system_log_show(\'语音验证码模板审核\',\'<c:url value="/voiceVerify/toTempCertification?type=show"/>\',' + full.id + ',\'550\',\'550\')" class="ml-5" style="text-decoration:none; color:blue">查看</a>';
                    }
    ...
    function downloadReport() {
        ...
        window.open("<c:url value='/voiceVerify/downloadReport'/>?" + formData);
    }
