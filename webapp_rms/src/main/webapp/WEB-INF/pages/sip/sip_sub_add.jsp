    ...
    <form action="<c:url value='/sip/addSub'/>" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" id="subName" name="subName" datatype="subName" maxlength="30" class="input-text" nullmsg="请输入子账号名称" errormsg="子账号名称格式不正确">
            </div>
            <div class="col-3"></div>
        </div>
        ...
        <!--
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>黑名单：</label>
            <div class="formControls col-6">
        ...
        <div class="row cl">
            <label class="form-label col-3">白名单：</label>
            <div class="formControls col-6">
                <input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;添加&nbsp;&nbsp;"/>
                <a>查看号码>></a>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input id="maxConcurrent" name="maxConcurrent" datatype="maxCon" class="input-text"/>
            </div>
            <div class="col-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text radius size-S" style="width: 100px;" maxlength="7" datatype="f1_2-2" value="100" name="discount" id="discount" onkeyup="discountPrice(this);" onpaste="return false" nullmsg="折扣率不允许为空" errormsg="请输入小于等于10000且精度不超过1位的小数！"/>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <label id="discountPrice">${sipRate.per60}元</label>
            </div>
            <div class="formControls col-3"></div>
        </div>
        ...
        <!--
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>子账号号码池：</label>
            <div class="formControls col-6">
                <input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;单个添加&nbsp;&nbsp;"/>
        ...
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>号码池列表：</label>
            <div class="formControls col-6">
                <a>查看号码>></a>
            </div>
            <div class="col-3"></div>
