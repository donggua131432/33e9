...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // datatables ajax 选项
        var datatables_ajax = {
            url: '<c:url value='/sip/pageAppList'/>',
            type: 'POST',
            "data": function(d){
        ...
        var columnDefs = [
...

            {
                ...
                "render": function(data, type, full) {
                    ...
                    _ex_in += '<a title="编辑" href="javascript:;" onclick="openRelayDialog(\'编辑\',\'<c:url value="/sip/toEditAppInfo?appId='+full.appId+'&managerType=edit"/>\',\'1000\',\'800\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>';
                    _ex_in += '<a title="查看" href="javascript:;" onclick="openRelayDialog(\'查看\',\'<c:url value="/sip/toShowAppInfo?appId='+full.appId+'&managerType=view"/>\',\'1000\',\'800\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"></i>查看</a>';
                    _ex_in += '<br/><a title="App专用路由" href="javascript:;" onclick="openUserDialog(\'App专用路由\',\'<c:url value="/sip/toEditAppRoute?appId='+full.appId+'"/>\',\'\',\'600\')" class="ml-5" style="text-decoration:none;color:blue;">App专用路由</a>';
                    return _ex_in;
                }
            }
        ];
    ...
    function downloadReport(type) {
        ...
        //
        window.open("<c:url value='/sip/downloadReport'/>?params[companyName]=" + $("#companyName").val()
