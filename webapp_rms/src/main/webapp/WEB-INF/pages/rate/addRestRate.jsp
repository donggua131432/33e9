        ...
        function discountPrice(obj){
            ...
            if(discount >= 0){
                if($(obj).attr("id") == "restaDiscount"){
                    ...
                    $("#restaDiscountPrice").text($.calcEval("${restRate.resta/100}*"+discount).toFixed(4));
                }else if($(obj).attr("id") == "restDiscount"){
                    $("input[name = 'restDiscount']").val($.calcEval(discount+"*10"));
                    $("#restDiscountPrice").text($.calcEval("${restRate.rest/100}*"+discount).toFixed(4));
                }else if($(obj).attr("id") == "recordingDiscount"){
                    $("input[name = 'recordingDiscount']").val($.calcEval(discount+"*10"));
                    $("#recordingDiscountPrice").text($.calcEval("${restRate.recording}/100*"+discount).toFixed(4));
                }
            }
        }
    </script>
...
<body>
<div class="pd-20">
    <form action="<c:url value='/restRate/submitRestRate'/>" method="post" class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
                                    ...
                                    <dl class="permission-list">
                                        ...
                                        <dd>
                                            <dl class="cl permission-list2">
                                                ...
                                                <dd><label class="">${restRate.resta}</label>元/分钟</dd>
                                            </dl>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">折扣率：</label></dt>
                                                <dd><label class=""><input type="text" class="input-text radius size-S" maxlength="6" style="width: 100px;" value="100" id="restaDiscount" onkeyup="discountPrice(this);"  datatype="f1_2-2" onpaste="return false" nullmsg="折扣率不允许为空" errormsg="请输入小于等于3000且精度不超过两位的小数！"/>%</label></dd>
                                                <input type="hidden" name="restaDiscount" value="1000"/>
                                            </dl>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">折后价：</label></dt>
                                                <dd><label class="" id="restaDiscountPrice">${restRate.resta}</label>元/分钟</dd>
                                            </dl>
                                            <dl class="cl permission-list2">
                                ...
                                <div class="formControls col-10">
                                    <dl class="permission-list">
                                        ...
                                        <dd>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">标准价格：</label></dt>
                                                <dd><label class="">${restRate.rest}</label>元/分钟</dd>
                                            </dl>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">折扣率：</label></dt>
                                                <dd><label class=""><input type="text" class="input-text radius size-S" maxlength="6" style="width: 100px;" value="100" id="restDiscount" onkeyup="discountPrice(this);"  datatype="f1_2-2" onpaste="return false" nullmsg="折扣率不允许为空" errormsg="请输入小于等于3000且精度不超过两位的小数！"/>%</label></dd>
                                                <input type="hidden" name="restDiscount" value="1000"/>
                                            </dl>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">折后价：</label></dt>
                                                <dd><label class="" id="restDiscountPrice">${restRate.rest}</label>元/分钟</dd>
                                            </dl>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">计费单位：</label></dt>
                                                <dd><label class="">分钟</label></dd>
                                ...
                                <div class="formControls col-10">
                                    <dl class="permission-list">
                                        ...
                                        <dd>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">标准价格：</label></dt>
                                                <dd><label class="">${restRate.recording}</label>元/分钟</dd>
                                            </dl>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">折扣率：</label></dt>
                                            ...
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">折后价：</label></dt>
                                                <dd><label class="" id="recordingDiscountPrice">${restRate.recording}</label>元/分钟</dd>
                                            </dl>
                                            <dl class="cl permission-list2">
                                                <dt><label class="form-label">计费单位：</label></dt>
                                                <dd><label class="">分钟</label></dd>
