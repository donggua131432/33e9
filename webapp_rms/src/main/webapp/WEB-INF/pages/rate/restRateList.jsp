...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            //dataTablesAjax 选项
            var dataTablesAjax = {
                url: '<c:url value='/restRate/pageRestRateUnion'/>',
                type: 'POST',
                "data": function(d){
            ...
            var columnDefs = [
                ...
                {"targets": [7], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return ${restRate.resta};
                    }
                },
                {"targets": [8], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return (full.restA_discount/10);
                    }
                },
                {"targets": [9], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return $.calcEval("${restRate.resta}*"+full.restA_discount+"/1000").toFixed(4);
                    }
                },
                {"targets": [10], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return ${restRate.rest};
                    }
                },
                {"targets": [11], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return (full.rest_discount/10);
                    }
                },
                {"targets": [12], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return $.calcEval("${restRate.rest}*"+full.rest_discount+"/1000").toFixed(4);
                    }
                },
                {"targets": [13], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return ${restRate.recording};
                    }
                },
                ...
                {"targets": [15], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return $.calcEval("${restRate.recording}*"+full.recording_discount+"/1000").toFixed(4);
                    }
                },
                {"targets": [16], "data": "id", "sClass" : "text-c",
                    "render": function(data, type, full) {
                        return '<a title="查看" href="javascript:;" onclick="restRate_openDialog(\'专线语音费率配置详情\',\'<c:url value="/restRate/getRestRateDetail?feeid='+full.feeid+'"/>\',\'800\',\'700\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont" style="font-size: 18px; color: green;">&#xe695;</i>查看</a>';
                    }
                }
            ];
...
<div class="pd-20">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            <thead>
                <tr>
                    <th scope="col" colspan="17">专线语音费率列表</th>
                </tr>
                <tr class="text-c">
