        ...
        function discountPrice(obj){
            ...
            if(discount >= 0){
                if($(obj).attr("id") == "per60Discount"){
                    ...
                    $("#per60DiscountPrice").text($.calcEval("${voiceVerifyRate.per60}*"+discount+"/100").toFixed(4));
                }
                if($(obj).attr("id") == "perDiscount"){
                    $("input[name = 'perDiscount']").val($.calcEval(discount+"*10"));
                    $("#perDiscountPrice").text($.calcEval("${voiceVerifyRate.per}*"+discount+"/100").toFixed(4));
                }
            }
        }
...
<body>
<div class="pd-20">
    <form action="<c:url value='/voiceVerifyRate/submitVoiceVerifyRate'/>" method="post" class="form form-horizontal" id="addVoiceRateForm">
        <div class="row cl">
                                    ...
                                    <dl class="permission-list">
                                        <dd>
                                            <dl class="cl permission-list2">
                                                ...
                                                <dd>
                                                    <input type="radio" id="acountType1" name="feeMode" value="01" onclick="switchTab('#pattern_one', '#pattern_two');" checked="checked"><label for="acountType1">按条计费</label>
                                                    <input type="radio" id="acountType2" name="feeMode" value="00" onclick="switchTab('#pattern_two', '#pattern_one');" ><label for="acountType2">按分钟计费</label>
                                                </dd>
                                            </dl>
                                            <dd id="pattern_one">
                                                <dl class="cl permission-list2">
                                                    <dt><label class="form-label">标准价格：</label></dt>
                                                    <dd class="form-text"><label>${voiceVerifyRate.per}</label>元/条</dd>
                                                </dl>
                                                <dl class="cl permission-list2" >
                                                    <dt><label class="form-label">折扣率：</label></dt>
                                                    <dd><label class=""><input type="text" class="input-text radius size-S" style="width: 100px;" maxlength="6" datatype="f1_2-2" value="100" id="perDiscount" onkeyup="discountPrice(this);" onpaste="return false" nullmsg="折扣率不允许为空" errormsg="请输入小于等于3000且精度不超过1位的小数！"/>%</label></dd>
                                                    <input type="hidden" name="perDiscount" value="${voiceVerifyRate.perDiscount}"/>
                                                </dl>
                                                <dl class="cl permission-list2">
                                                    <dt><label class="form-label">折后价：</label></dt>
                                                    <dd class="form-text"><label id="perDiscountPrice">${voiceVerifyRate.per}</label>元/分钟</dd>
                                                </dl>
                                            </dd>
                                            <dd id="pattern_two" style="display: none;">
                                                <dl class="cl permission-list2">
                                                    <dt><label class="form-label">标准价格：</label></dt>
                                                    <dd class="form-text"><label>${voiceVerifyRate.per60}</label>元/分钟</dd>
                                                </dl>
                                                <dl class="cl permission-list2">
                                                    <dt><label class="form-label">折扣率：</label></dt>
                                                ...
                                                <dl class="cl permission-list2">
                                                    <dt><label class="form-label">折后价：</label></dt>
                                                    <dd class="form-text"><label id="per60DiscountPrice">${voiceVerifyRate.per60}</label>元/分钟</dd>
                                                </dl>
                                            </dd>
                                        </dd>
                                    </dl>
