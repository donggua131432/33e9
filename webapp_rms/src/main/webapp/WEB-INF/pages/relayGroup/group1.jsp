...
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <a href="javascript:void(0);" onclick="openUserDialog('新增中继','<c:url value="/relaygroup1/toAddRelayGroup1"/>','950','700');" class="btn btn-primary radius">新增中继</a>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="15%">城市</th>
                <th width="15%">电话区号</th>
                <th width="10%">号段起始号码</th>
                <th width="10%">号段结束号码</th>
                <th width="15%">操作</th>
            </tr>
            </thead>
        </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        //dataTablesAjax 选项
        var dataTablesAjax = {
            url: '<c:url value="/relaygroup1/pageGroup1"/>',
            type: 'POST',
            "data": function(d){
        ...
        var columnDefs = [
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    _ex_in += '<a title="编辑" href="javascript:;" onclick="openUserDialog(\'编辑\',\'<c:url value="/relaygroup1/RelayGroup1EditView?id='+full.id+'&operationType=edit"/>\',\'1000\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>';
                    _ex_in += '<a title="查看" href="javascript:;" onclick="openUserDialog(\'查看\',\'<c:url value="/relaygroup1/RelayGroup1EditView?id='+full.id+'&operationType=view"/>\',\'700\',\'600\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"></i>查看</a>';
...
//            "aaSorting": [ 1, "desc" ], // 默认的排序列（columns）从0开始计数
    ...
    function importNumber(){
        openDialog('批量导入', '<c:url value="/relaygroup1/toImportGroup1"/>?g=1', '600', '260');
    }
    ...
    function deleteRelayInfo(id,appid){
        layer.confirm('是否确定删除？', {
            ...
            $.ajax({
                type:"post",
                url:"<c:url value='/relaygroup1/deleteRelayGroup1'/>",
                dataType:"json",
                data:{"id" : id},
