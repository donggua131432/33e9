...
<body>
<div class="pd-20">
    <form action="<c:url value="/relaygroup1/saveRelayGroup1" />" method="post" class="form form-horizontal" id="addRelayGroup1">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-7">
                <input type="text" class="input-text" value="" placeholder="支持中英文数字,最大不超过100个汉字" id="cityName" name="cityName" datatype="zh1-100|n1-100|s1-100" maxlength="100" errormsg="城市不合法！" nullmsg="城市不能为空"/>
            </div>
            <div class="col-3"></div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red"></span>电话区号：</label>
            <div class="formControls col-7">
                <input type="text" class="input-text" value="" placeholder="最大不超过11个数字" id="areaCode" name="areaCode" datatype="empty|n9-11" maxlength="11" errormsg="联系方式不合法！" />
            </div>
            <div class="col-3"></div>
        </div>
