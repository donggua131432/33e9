...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // datatables ajax 选项
        var datatables_ajax = {
            url: '<c:url value='/maskRingtone/list'/>',
            type: 'POST',
            "data": function(d){
                ...
                "render": function(data, type, full) {
                    ...
                    if(status == '00'){
                        return '<a title="审核" href="javascript:;" ' +
                                'onclick="system_log_show(\'铃声审核\',\'<c:url value="/maskRingtone/toShowCertification?type=edit"></c:url>\',' + full.id + ',\'600\',\'600\')" class="ml-5" style="text-decoration:none; color:blue">审核</a>';
                    }else if(status == '01'){
                        return '<a title="查看" href="javascript:;" ' +
                                'onclick="system_log_show(\'铃声审核\',\'<c:url value="/maskRingtone/toShowCertification?type=show"></c:url>\',' + full.id + ',\'600\',\'600\')" class="ml-5" style="text-decoration:none; color:blue">查看</a>';
                    }
                    else if(status == '02'){
                        return '<a title="查看" href="javascript:;" ' +
                                'onclick="system_log_show(\'铃声审核\',\'<c:url value="/maskRingtone/toShowCertification?type=show"></c:url>\',' + full.id + ',\'600\',\'600\')" class="ml-5" style="text-decoration:none; color:blue">查看</a>';
