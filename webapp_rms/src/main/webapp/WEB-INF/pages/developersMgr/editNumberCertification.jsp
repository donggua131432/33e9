    ...
    <script type="text/javascript">
        ...
        function submitToAuth(){
            ...
            if(status == "请选择") {
                ...
                $.post("<c:url value='/number/editAudit'/>",{status:status,appId:appId, comment:comment, id:id},function(result){
                    if(result.status==0){
                        /*parent.refresh();*/
...
<div class="pd-20">
    ...
    <form class="form form-horizontal" id="form-edit">
        <input type="hidden" id="id" name="id" value="${appNumber.id}"/>
        <input type="hidden" id="appid" name="appid" value="${appNumber.appid}"/>
