...
public class Page implements Serializable {
    ...
    private Date monthmax;

    // 最小时间(日期)
    @DateTimeFormat(pattern = "yyyy-MM")
    private Date monthmin;
    ...
    public Date getMonthmin() {
        return monthmin;
    }

    public void setMonthmin(Date monthmin) {
        this.monthmin = monthmin;
    }

    public Date getMonthmax() {
        return monthmax;
    }

    public void setMonthmax(Date monthmax) {
