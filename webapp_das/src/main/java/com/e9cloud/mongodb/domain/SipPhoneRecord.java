...
/**
 * 云话机 通话记录
 * Created by hzd on 2016/12/6.
 */
public class SipPhoneRecord implements Serializable{
    ...
    private String sippA;
    private String sippB;
    private String appid; //应用ID
    private String feeid; //费率ID
    private String subid; //子账号ID
    private String sid; //Account ID
    private String display; //显示号码
    private String aTelno; //A路主叫号码
    private String bTelno; //B路被叫号码

    private String zj; //A路主叫号码
    private String bj; //B路被叫号码
    ...
    private String rcdType; // 呼叫类型(回拨 : SIPPREST, 直拨 : SIPPOUT, 回呼 : SIPPIN)
    ...
    public void setSippA(String sippA) {
        this.sippA = sippA;
    }

    public void setSippB(String sippB) {
        this.sippB = sippB;
    }

    public String getSippA() {

        return sippA;
    }

    public String getSippB() {
        return sippB;
    }
    ...
    public Double getAllFee () {
        return this.fee + this.recordingFee;
    }
