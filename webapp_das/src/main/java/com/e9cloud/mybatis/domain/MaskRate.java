...
public class MaskRate {
    ...
    public BigDecimal getRecordingCallback() {
        if(recordingCallback != null){
            return recordingCallback.setScale(3);
        }
        return null;
    }
