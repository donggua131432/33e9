...
!function($) {
    ...
    Modal.prototype = {
        ...
        hideModal: function() {
            ...
            var reload = this.options.reload || this.$element.attr("reload");
        ...
        reload: function(args){
            if(args != null && args != undefined){
                this.$element.find("form :input").each(function(){
                    $(this).val(args[$(this).attr("name")]).removeClass("Validform_error");
                });
            }else{
                this.$element.find("form :input").val("");
            }
            this.$element.find(".Validform_checktip").parent().html('<span class="Validform_checktip"></span>');
        }
    };
