...
<div class="pd-20">
    ...
    <div class="text-l">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        Appid：<input type="text" id="appid" name="appid" class="input-text" placeholder="Appid ID" style="width:200px;">
        <%--应用名称：<select id="appid" name="appid" class="input-text" style="width:200px">
                    <option value="">全部</option>
                </select>--%>
        &nbsp;&nbsp;&nbsp;&nbsp;
        主叫号码：
        <input type="text" class="input-text" style="width:186px" placeholder="请输入主叫号码" id="aTelno" name="aTelno"/>&nbsp;&nbsp;&nbsp;&nbsp;
        被叫号码：
        <input type="text" class="input-text" style="width:186px" placeholder="请输入被叫号码" id="bTelno" name="bTelno"/>&nbsp;&nbsp;&nbsp;&nbsp;
        隐私号码：
        <input type="text" class="input-text" style="width:186px" placeholder="请输入隐私号码" id="display" name="display"/>
    </div><br>
    <div class="text-l">
        城市：
        <select type="text" id="city" name="city" placeholder="城市" class="input-text" style="width:200px;">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="15%">callid</th>
                <th width="5%">主叫号码</th>
                <th width="5%">被叫号码</th>
                <th width="5%">隐私号码</th>
                <th width="5%">城市</th>
                <th width="4%">录音<br>状态</th>
                <th width="4%">接通<br>状态</th>
                <th width="6%">开始时间</th>
                <th width="6%">结束时间</th>
                <th width="5%">通话时长</th>
                <th width="3%">落地线路</th>
                <th width="4%">线路错误码</th>
                <th width="2%">通话<br>费用</th>
                <th width="2%">录音<br>费用</th>
                <th width="6%">录音<br>下载</th>
            </tr>
            </thead>
        </table>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // datatables ajax 选项
        var datatables_ajax = {
            url: '<c:url value='/recordlist/pageMaskCallRecord'/>',
            type: 'POST',
            "data": function(d){
    ...
    function downloadReportCommon() {
        ...
        var param = "?code=03&feeid="+ feeid + "&pageCount=" + total+"&conds=" + condParam;
