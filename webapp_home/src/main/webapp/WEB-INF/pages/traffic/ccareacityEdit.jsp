...
<head>
    ...
    <script type="text/javascript">
        ...
        var pcsetting = {
            ...
            async: {
                enable: true,
                url:"<c:url value="/smartCloud/traffic/ccareacity/pctree"/>?sid=${area.sid}"
            },
            data:{
                simpleData:{
                    enable: true,
        ...
        var asetting = {
            ...
            async: {
                enable: true,
                url:"<c:url value="/smartCloud/traffic/ccareacity/atree"/>?areaId=${area.areaId}"
            },
            data:{
                simpleData:{
                    enable: true,
                ...
                datatype: {
                    "uniqueAname": function (gets, obj, curform, datatype) {
                        ...
                        $.ajax({
                            async:false,
                            type: "post",
                            url: "<c:url value="/smartCloud/traffic/ccareacity/uniqueAname"/>",
                            dataType: "json",
...
<body>
<div class="pd-20">
    <form action="<c:url value="/smartCloud/traffic/ccareacity/editArea"/>" method="post" class="form form-horizontal" id="addCustomerManager">
        ...
        <div class="row cl">
            <label class="form-label col-2">区域描述：</label>
            <div class="formControls col-8">
                <textarea name="remark" id="remark"  maxlength="100" style="padding:5px 5px;font-size: 15px;" cols="57" rows="4">${area.remark}</textarea>
            </div>
            <div class="col-2"></div>
        </div>
