...
<head>
    ...
    <script type="text/javascript">
        ...
        var pcsetting = {
            ...
            async: {
                enable: true,
                url:"<c:url value="/smartCloud/traffic/ccareacity/pctree"/>?sid=${sid}"
            },
            data:{
                simpleData:{
                    enable: true,
...
<body>
<div class="pd-20">
    <form action="<c:url value="/smartCloud/traffic/ccareacity/addArea?sid=${sid}"/>" method="post" class="form form-horizontal" id="addCcAreaCity">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                <textarea name="remark" id="remark"  maxlength="100" style="padding:5px 5px;font-size: 15px;" cols="57" rows="4"></textarea>
            </div>
            <div class="col-2"></div>
        </div>
