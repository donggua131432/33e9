...
<div class="register">
    ...
    <div class="registMian">
        <ul class="registBg">
            ...
            <li class="letter">完成注册</li>
        </ul>
    </div>
    <div class="regist_tit">
        <h3 class="text_center letter zColor">您的邮箱<span class="blueFont f36 letter">${email}</span>验证邮件已发送<br/>请登录您的邮箱，点击邮件内注册链接完成后续步骤</h3>
        <ul class="regist_iput inform">
            <li class="regist_rigM"><a href="javascript:toemail();" class="blueBtn Btn_w400 send">登录邮箱</a> </li>
        </ul>
    </div>
</div>
