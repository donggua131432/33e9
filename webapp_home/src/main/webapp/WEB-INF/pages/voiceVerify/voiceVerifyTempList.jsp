...
<head>
    ...
    <script id="appListTemplate" type="text/x-jquery-tmpl">
        <tr class="date_hg">
            <td>\${appName}</td>
            <td>\${appid}</td>
            <td><a href="<c:url value='/voiceverifyTemp/index?appid=\${appid}&appName=\${appName}'/>">点击管理</a></td>
            <td><a href="<c:url value='/voiceverifyTemp/voiceverifyNumList?appid=\${appid}'/>">外显号码列表</a></td>
        </tr>
    </script>
