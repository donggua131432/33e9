...
<section>
    <div id="sec_main">
        ...
        <script type="text/javascript">showSubMenu('kf','appMgr','axbNumList');</script>
        <!-- 左侧菜单 end -->
            ...
            <div class="container1" >
                ...
                <div class="application_msg">
                    <div class="app_select" id="searchForm">
                        ...
                        <span class="check_font">城市 :</span>
                            <select id="id" name="id">
                                <option selected value="">全部</option>
                            </select>
                        <span class="check_font">号码:</span>
                        <input type="text" id="number" name="number" size="18" maxlength="30" class="input_style" style="width:220px;"/>
                    ...
                    <div class="application clear">
                        <div class="record_down f_right">
                            <span  onclick="downloadReport('');" class="open_down_billed"><i class="common_icon download_txt"></i>导出列表</span>
                        </div>
                        <div id="dayReport">
                            <table class="table_style"  id="axbNum">
                                <thead>
                                <tr>
...
<script type="text/javascript">
    ...
    cityInfoArray = getAppInfo("<c:url value='/axbNumMgr/getCityInfo'/>","id","cname");
   });

    //查询号码记录
    var table =
    $("#axbNum").page({
        url:"<c:url value='/axbNumMgr/pageAxbNum'/>",
    ...
    function downloadReport(type) {
        ...
        $.fn.downloadReport("<c:url value='/axbNumMgr/downloadReport'/>");
    }
