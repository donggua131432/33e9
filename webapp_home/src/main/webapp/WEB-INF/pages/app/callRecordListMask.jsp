...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#callListTable").page({
                url:"<c:url value='/maskRecord/getCallRecordList'/>",
                pageSize:30,
            ...
            $("#businessType").on("change",function(){
                if($(this).val() == 0){
                    $("#abLine").empty();
                    $("#abLine").append("<option value=''>全部</option>");
                }else if($(this).val() == 1){
                    $("#abLine").empty();
                    $("#abLine").append("<option value='AB'>全部</option>").append("<option value='A'>主叫</option>").append("<option value='B'>被叫</option>");
                }else if($(this).val() == 2){
                    $("#abLine").empty();
                    $("#abLine").append("<option value='C'>全部</option>");
                }
            })
        });
...
<section>
    <div id="sec_main">
        ...
        <script type="text/javascript">showSubMenu('kf','appMgr','maskCallRecord');</script>
        <!-- 左侧菜单 end -->
        <div class="main3">
            <!--消息显示-->
                    ...
                    <form id="searchForm">
                        <div class="record_select">
                            <div class="Open_interface_record re_span_common clear">
                                ...
                                <span class="check_font call_left">城&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;市：</span>
                                <select id="displayPoolCity" name="displayPoolCity" style="width: 188px;">
                            ...
                            <div class="Open_interface_record re_span_common">
                                ...
                                <span class="check_font">业务类型：</span>
                                <select id="businessType" name="businessType" style="width: 80px;"  autocomplete="off">
                                    <option value="0">全部</option>
                                    <option value="1">回拨</option>
                                    <option value="2">回呼</option>
                                </select>

                                <span class="check_font" >呼叫类型：</span>
                                <select id="abLine" name="abLine" style="width: 80px;">
                                    <option value="">全部</option>
                                </select>

                                <span class="check_font call_left">号&nbsp;&nbsp;&nbsp;&nbsp;码：</span>
                                <input type="text" id="display" name="display" class="input_style"/>
                            </div>
