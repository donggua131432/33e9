...
<section>
    <div id="sec_main">
        ...
        <script type="text/javascript">showSubMenu('kf','appMgr','secretList');</script>
        <!-- 左侧菜单 end -->
        ...
        <div class="main3">
            ...
            <div class="container">
                ...
                <form id="voiceForm" name="voiceForm" action="<c:url value='/secretMgr/save'/>" method="post" enctype="multipart/form-data">
                    <div class="ringEdit">
                        ...
                        <div class="create_app_common parentPosition">
                            <label  class="create_app_title_left" >铃声上传:</label>
                            <input type="text" id="voiceUrl1" name="voiceFile1" class="l_input_style" style="width:400px;"/>
                            ...
                            <input type="file" class="childPosition" style="left:525px;" name="voiceFile" id="voiceUrl" onchange="document.getElementById('voiceUrl1').value=this.value" />

                            <div><i class="create_ring_name_note ringTip">*铃声只支持原生WAV格式，最大支持2M。</i></div>
                            <%--<div id="errormsg" class="create_ring_name_note ringTip">--%>
                        ...
                        <div class="create_app_common">
                            ...
                            <span class="create_app_title_left"><input type="text" onkeyup="checkVoiceName(this);" id="voiceName" name="voiceName" maxlength="10" class="l_input_style" style="width:400px;"/></span>
                            <div id="errorVoiceNameMsg" class="Error_box" style="margin: 15px 0 -25px 103px;width: 400px;"></div>
                        </div>
                        <div class="create_button">
                            <button type="button" id="voiceButton" name="voiceButton" class="sm_btn">提交</button>
