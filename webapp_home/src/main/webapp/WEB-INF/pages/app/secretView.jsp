            ...
            <div class="container">
                ...
                <div class="ringEdit">
                    ...
                    <div class="create_app_common">
                        ...
                        <span class="ringDownL_icon"></span><a href="<c:url value='/secretMgr/download'/>?url=${voice.voiceUrl}" class="ringDownLoad">下载</a>
                    </div>
...
<script type="text/javascript">
    $("#goList").click(function(){
        window.location="<c:url value='/secretMgr/index'/>";
    })
</script>
