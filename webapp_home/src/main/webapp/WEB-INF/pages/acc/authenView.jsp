            ...
            <div class="container2">
                ...
                <div class="validation_msg">
                    ...
                    <p class="id_test">
                        ...
                        <!--<a href="#" class="alert_base_msg id_left"><i class="common_icon alter_txt"></i>修改</a>-->
                    </p>
                    <div class="warpper">
                        <form id="authForm" name="authForm" action="<c:url value='/authen/save'/>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="company">
                                <div class="cpy_intro">
                                    <label>公司名称：</label>
                                    <input type="text" class="l_input_style" size="50" id="com_name" name="name" maxlength="30"/><br/>
                                    <label>公司地址：</label>
                                    <input type="text" class="l_input_style" size="50" id="address1" name="address" maxlength="50"/><br/>
                                    <label>所属行业：</label>
                                ...
                                <div class="organization">
                                    ...
                                    <div id="pattern_one">
                                        ...
                                        <input type="text" class="l_input_style input_bottom" size="50" id="creditNo" name="creditNo" class="input_bottom" maxlength="18"/><i>18位数字或者大写英文字母</i><br/>
                                        <label>营业执照：</label>
                                        <input type="text" id="id_photo1" name="businessLicenseFile1" class="l_input_style" size="50"/>
                                        ...
                                        <p class="p_Top">*&nbsp;将原件或盖章的复印件扫描、拍照后上传；<br/>
                                            文件支持2M以内的PNG/JPG/GIF格式；<br/>
                                            Mac OS系统请使用新版Firefox浏览器上传。
                                        </p>
                                    </div>
                                    ...
                                    <div id="pattern_two" style="display: none;" >
                                        ...
                                        <input type="text" class="l_input_style input_bottom" size="50" class="input_bottom" id="registerNo" name="registerNo" maxlength="15"/> <i>15位数字</i><br/>
                                        <label>税务登记号：</label>
                                        <input type="text" class="l_input_style label_left" size="50" class="label_left" id="taxRegNo" name="taxRegNo" maxlength="15"/> <i>15位数字</i><br/>
                                        <label>营业执照：</label>
                                        <input type="text" id="id_photo2" name="businessLicenseFile1" class="l_input_style" size="50"/>
                                    ...
                                    <div id="pattern_three" style="display: none;">
                                        <label>税务登记号：</label>
                                        <input type="text" class="l_input_style label_left" size="50" class="label_left" id="taxRegNo1" name="taxRegNo" maxlength="15"/> <i>15位数字</i><br/>
                                        <label>税务登记证：</label>

                                        <input type="text" id="taxRegPic" name="taxRegFile1" class="l_input_style" size="50" style="margin-left:-16px;"/>
                                        ...
                                        <input type="text" class="l_input_style label_left" size="50"
                                               class="label_left" id="businessLicenseNo" name="businessLicenseNo" maxlength="15"/> <i>15位数字</i><br/>
                                        <label>营业执照：</label>
                                        <input type="text" id="id_photo3" name="businessLicenseFile1" class="l_input_style" size="50"/>
                                    ...
                                    <!--<label>组织机构证：</label>-->
                                    <!--<p class="p_left"> <img src="<c:url value="/nasimg/anthen/${businessLicensePic}"/>" alt="组织机构证"/></p>-->
                                </div>
                                <div class="Legal">
                                    <label for="legal">法定代表人：</label>
                                    <input type="text" id="legal" name="legalRepresentative" class="l_input_style" size="50" placeholder="请填写公司的法人代表姓名"  maxlength="20"/>
                                    <br/>
                                    <label for="cpy_number">公司电话：</label>
                                    <input type="text" id="cpy_number" name="telno"  maxlength="15" class="l_input_style" size="50" placeholder="请填写您的联系电话，如010-25465662"/>
                                    <br/>
                                    <label for="cpy_web">公司网站：</label>
                                    <input type="text" id="cpy_web" name="website" class="l_input_style" size="50"  placeholder="http://www."/>
                                    <i>*非必填内容</i>
                                </div>
...
<script type="text/javascript">
    ajaxDicData('${appConfig.authUrl}',"tradeType","tradeId",'0');
