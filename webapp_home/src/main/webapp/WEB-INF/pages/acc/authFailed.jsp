...
<head>
    ...
    <script src="${appConfig.resourcesRoot}/js/my-new.js"></script>
</head>
<body>
            ...
            <div class="container2" >
                ...
                <div class="validation_msg">
                    ...
                    <p class="id_test">
                        ...
                        <span class="alert_base_msg id_left">
                            ...
                            <img src="${appConfig.resourcesRoot}/img/noPass.png" alt="图片"/>
                             <a class="reTestMsg" href="<c:url value='/authen/authAgain'/>">重新认证&gt;&gt;</a>
                    ...
                    <div class="warpper">
                        <form action="">
                            ...
                            <div class="company">
                                ...
                                <div class="Legal">
                                    ...
                                    <label>公司网站：</label>
                                    <span class="test_msg_common"><c:out value="${company.website}"/></span><br/>
                                </div>
                                <div>
                        ...
                        <button type="button" id="anthAgain" name="anthAgain" class="sm_btn SmTop">重新认证</button>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $("#anthAgain").click(function(){
        window.location="<c:url value='/authen/authAgain'/>";
    })
</script>
</body>
</html>
