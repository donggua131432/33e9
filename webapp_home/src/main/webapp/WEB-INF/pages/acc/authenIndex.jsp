                ...
                <div class="validation_msg">
                    ...
                    <p class="id_test">
                        ...
                        <span class="alert_base_msg id_left">
                            ...
                            <img src="${appConfig.resourcesRoot}/img/pass.png" alt="图片"/>
                                ...
                                <c:if test="${company.cardType =='1'}">
                                    <div class="organization">
                                        ...
                                        <div id="pattern_two">
                                            ...
                                            <label>营业执照：</label>
                                            <span class="amplification" data-mark="mark"><i class="amplification_txt"></i>查看大图</span>
                                            <p class="p_left"> <img data-mark="mark" class="certificateImg clear" src="<c:url value="/nasimg/anthen/${company.businessLicensePic}"/>" alt="组织机构证"/></p>
                                        </div>
                                    </div>
                                </c:if>
