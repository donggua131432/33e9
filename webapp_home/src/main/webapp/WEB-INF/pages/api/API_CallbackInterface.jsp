    ...
    <div class="main_box">
        <div class="main_box">
            <div class="API_box">
                ...
                <div id="api_ma2_1">
                    <div class="api_m2"><span>专线语音回调通知接口</span></div>
                    <div>
                        <div class="api_m2_box API1">
                            <span class="api_com_font">1.专线语音回调通知AS接口介绍</span>
                            <p>
                            ...
                            <p>
                                <a href="${appConfig.resourcesRoot}/master/file/callBacknotify.zip" class="load" download="callBacknotify.zip"> <b class="icon downTxt"></b>回调通知接口示例代码（即Demo）下载</a>
                            </p>
                        </div>
                        <div class="api_m2_box API2">
                            <span class="api_com_font">2.回调通知AS接口接入及使用流程</span>
                        ...
                        <div class="api_m2_box API3">
                            <span class="api_com_font">3.回调通知AS接口详述</span>
                            <p class="APIlgFont">呼叫发起通知接口</p>
                            <p>此接口用于呼叫发起的时候，平台通知用户AS服务器。平台呼叫A路及B路是会分别发出通知。</p>
...
&lt;/Response&gt;
                            ...
                            <p class="APIlgFont marginTop">呼叫建立通知接口</p>
                            <p>此接口用于B路（被叫）接听后，通话建立成功的时候。平台通知用户AS服务器呼叫已经建立。</p>
                            <p class="APImdFont">请求地址</p>
                            <p>用户创建应用时自行配置URL地址。通过POST方式请求通知用户，只提供XML格式。</p>
                            <p class="APImdFont">请求包头</p>
                            <table class="API_style">
...
&lt;/Response&gt;
                            ...
                            <p class="APIlgFont marginTop" id="hdtz">呼叫挂机计费通知接口</p>
                            ...
                            <table class="API_style">
                                ...
                                <tr>
                                    ...
                                    <td>必选</td>
                                    <td>外呼显号标示</td>
                                    <td>0:不显号 1:一方显号 2:双方均显号（取值为2仅双向回拨时存在）</td>
                                </tr>
                                <tr>
                                    <td>callId</td>
                                    <td>String</td>
                            ...
                            <p>
                                ...
                                <span class="redFont">(4)byeType：挂机原因，包含正常挂机及异常挂机多种情况</span>
                            </p>
                            <p class="APImdFont">用户AS响应包头</p>
                            <table class="API_style">
                                <tr>
                ...
                <div class="API_main3 f_left">
                    ...
                    <div class="api_right_box THeight">
                        <div class="api_right_center">
                            <p class="b1"><b class="b"></b>1&nbsp;回调AS接口介绍</p>
