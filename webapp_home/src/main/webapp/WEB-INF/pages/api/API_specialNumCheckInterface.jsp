    ...
    <div class="main_box">
        <div class="API_box">
            ...
            <div class="API_main2 f_left" style="clear: both">
                ...
                <div id="api_ma2_1">
                    <div class="api_m2"><span>专号通号码查询接口</span></div>
                    <div>
                        <div class="api_m2_box API1">
                            <span class="api_com_font">1.专号通号码查询接口介绍</span>
                            <p>
                                本接口用于查询真实号码A,B与专号通中间号码的映射关系。
                            </p>
                        </div>
                        <div class="api_m2_box API2">
                            <span class="api_com_font">2.请求地址</span>
                            <p class="blueBg">&nbsp;&nbsp;/{softVersion}/Accounts/{accountSid}/MaskNumber/query</p>
                        ...
                        <div class="api_m2_box API4">
                            ...
                            <pre class="blueBg">
    POST
    /2016-01-01/Accounts/798b9ec0eaa94142852aa2c402570146/MaskNumber/query?sig=<br/>&nbsp;&nbsp;6949C5F977B304EC5BB969FD8838D345HTTP/1.1
    Host:127.0.0.1:9080
    content-length: 272
...

    {
        "req": {
            ...
            "realNumB": "13412341234"
                            ...
                            <pre class="blueBg">
    POST
    /2016-01-01/Accounts/798b9ec0eaa94142852aa2c402570146/MaskNumber/query?sig= <br/>&nbsp;&nbsp;230AB7B77C951C9DB5FECD55B3AFB3CFHTTP/1.1
    Host:127.0.0.1:9080
    content-length: 357
            ...
            <div class="API_main3 f_left">
                ...
                <div class="api_right_box fireHeight">
                    <div class="api_right_center">
                        <p class="b1"><b class="b"></b>1&nbsp;专号通号码查询介绍</p>
