...
public class RSAUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String modulePri = privateKey.getModulus().toString(16);
		String dempoent = privateKey.getPrivateExponent().toString(16);

		System.out.println(module);
		System.out.println(empoent);
		System.out.println(modulePri);
		System.out.println(dempoent);
	}
}
