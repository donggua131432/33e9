...
public class WhiteNumberClient {
...
//		 operateXML();
	...
	private static void operateJson() {
		...
		String url = serverUri + "/2016-01-01/Accounts/" + accountSid + "/White/operate";

		String body = "{'req': {'appId': 'b6f55ae1e5344782bccf03a8fc526460','action': 'add'," +
				"'number': '13632672293','type': 'S','validTime': 10800}}";
		String result = "";
	...
	private static void operateXML() {
		System.out.println("operateXML");
		String accountSid = "2c565993288f4097b22e38f500c91f92";
		String authToken = "4b5270819b024b39ae07bdcd984846ef";
		String url = serverUri + "/2016-01-01/Accounts/" + accountSid + "/White/operate";
